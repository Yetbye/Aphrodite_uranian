...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='wav2lip',
                        help="avatar model: musetalk/wav2lip/ultralight/flashhead/liveact")
    ...
    # SoulX 模型参数
    parser.add_argument('--flashhead_ckpt', type=str, default='./models/SoulX-FlashHead-1_3B', help="FlashHead checkpoint directory")
    parser.add_argument('--liveact_ckpt', type=str, default='./models/SoulX-LiveAct', help="LiveAct checkpoint directory")
    parser.add_argument('--wav2vec_dir', type=str, default='./models/wav2vec2-base-960h', help="Wav2vec checkpoint directory")
    parser.add_argument('--liveact_size', type=str, default='416*720', help="LiveAct size")
    parser.add_argument('--launch_backend', action='store_true', help="Launch the heavy model backend in a separate Conda environment via subprocess")
    parser.add_argument('--backend_env', type=str, default='', help="The Conda environment name to use when launch_backend is True (e.g., 'flashhead' or 'liveact')")
